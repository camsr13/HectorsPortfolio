...
export async function getStaticPaths() {
  ...
  const projectsURL = `https://mzjkcltq.api.sanity.io/v1/data/query/production?query=[${projectsQuery}]`
...
export async function getStaticProps(context) {
  ...
  const projectURL = `https://mzjkcltq.api.sanity.io/v1/data/query/production?query=[${projectQuery}]`
